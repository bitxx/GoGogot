...
func DefaultCompaction() orchestration.CompactionConfig {
	return orchestration.DefaultCompactionConfig()
}
...
// sanitizePromptValue prevents dynamic values from injecting prompt structure.
